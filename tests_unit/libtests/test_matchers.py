...
def test__single_level_dict__noop() -> None:
    fst = {"id": 123, "first_name": "James", "last_name": "Joy"}
    snd = {"id": 123, "first_name": "James", "last_name": "Joy"}
...
def test__single_level_dict__single_assignment() -> None:
    fst = {"id": 123, "first_name": "James", "last_name": "Joy"}
    snd = {"id": 123, "first_name": "Bill", "last_name": "Joy"}

    assert fst == obj_matcher(snd, {"= /first_name": "James"})


def test__single_level_dict__multiple_assignments() -> None:
    fst = {"id": 123, "first_name": "James", "last_name": "Joy"}
    snd = {"id": 456, "first_name": "Bill", "last_name": "Joy"}

    assert fst == obj_matcher(snd, {"= /id": 123, "= /first_name": "James"})


def test__single_level_dict__single_delete() -> None:
    fst = {"id": 123, "last_name": "Joy"}
    snd = {"id": 123, "first_name": "Bill", "last_name": "Joy"}

    assert fst == obj_matcher(snd, {"- /first_name": None})
...
def test__single_level_dict__assign_and_delete() -> None:
    ...
    assert fst == obj_matcher(snd, {"= /id": 123, "- /first_name": None})
